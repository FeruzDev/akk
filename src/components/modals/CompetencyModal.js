    ...
    return (
        <>
            ...
            <Modal  isOpen={props.locationModal} toggle={() => props.setLocationModal(false)}
                    ...
                    <div className="row">
                        <div className="col-md-12 my-form-groups   ">
                            <div className="my-select-style">
                                <label htmlFor="dd2" className="open-sans-semibold">{getText("codeList")} </label>
                        ...
                        <div className="col-md-12 my-form-groups mt-3">
                            <div className="my-input-style">
                                <label htmlFor="dd2" className="open-sans-semibold">{getText("code")}</label>
                                <div className="row flex-nowrap m-0 position-relative">
                                    <input type="text"
                ...
                <ModalFooter>
                    <button className="modal-save-btn" onClick={createCity}>{getText("save")}</button>
                </ModalFooter>
            </Modal>
            <Modal isOpen={props.locationModalSecond} toggle={() => {
                ...
                <ModalBody>
                    <div className="row">
                        <div className="col-md-12 my-form-groups">
                            <div className="my-input-style">
                                <label htmlFor="dd2" className="open-sans-semibold">{getText("innerCode")}</label>
                                <div className="row flex-nowrap m-0 position-relative">
                                    <input onChange={(e) => setCountry(e.target.value)}
                                           type="text"
                                           placeholder={getText("innerCode")}/>
                                </div>
                            </div>
                        </div>
                    </div>
