...
const InspectionBodyCheckModal = (props) => {
    return (
        <Modal
                        ...
                        <div className="my-input-groups col-md-6 m-0 justify-content-center">
                            ...
                            <div className="row">
                                <div className="col-md-6 m-0 justify-content-center">
                                    <label className="open-sans-bold m-0"> {getText("ser18")} </label>
                                    <span className="mb-3">{props.statusOrgNum ? props.statusOrgNum : "-"}</span>
                                </div>
                                <div className="col-md-6 m-0 justify-content-center">
                                    <label className="open-sans-bold m-0">{getText("ser19")}</label>
...
export default InspectionBodyCheckModal;
