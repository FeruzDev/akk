...
const ManagementSystemsCertificationCheckModal = (props) => {
    return (
                ...
                <div className="big-box">
                    ...
                    <div className="many-checks">
                        ...
                        <div className="lists mb-2">
                            {
                                props.designValue ? props.designValue?.map(item => (
                    ...
                    <div className="many-checks">
                        ...
                        <div className="lists mb-2">
                            {
                                props.certValue ? props.certValue?.map(item => (
                                        <span className="d-block">{item.label}</span>
                                    ))
                                    :
                                    "-"
...
export default ManagementSystemsCertificationCheckModal;
