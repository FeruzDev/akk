...
const MetrologicalLaboratories = () => {
    ...
    const sendData = () => {
        ...
        axios.post(API_APTH + "apps/application/send/0/", bigData, AUTH)
            .then(res => {
                toast.success("OK");
                setMainModal(false);
        ...
        <div className="ManagementSystemsCertification">
            ...
            <div className="container2">
                ...
                <div className="row inputs-box">
                                ...
                                <div className="row d-flex justify-content-end">
                                    <button className='btn btn-primary-private d-inline ' onClick={addElementToogle3Value}>Добавить ещё
                                    </button>
                                </div>
                </div>
                            :
                ...
                <div className="row inputs-box">
                                ...
                                <div className="row d-flex justify-content-end">
                                    <button className='btn btn-primary-private d-inline ' onClick={addElementToogle4Value}>Добавить ещё
                                    </button>
                                </div>
                </div>
                            :
                ...
                <div className="row inputs-box">
                                ...
                                <div className="row d-flex justify-content-end">
                                    <button className='btn btn-primary-private d-inline ' onClick={addElementToogle5Value}>Добавить ещё
                                    </button>
                                </div>
                </div>
                            :
...
export default MetrologicalLaboratories;
