...
const MedicalLaboratories = () => {
    ...
    const sendData = () => {
        ...
        axios.post(API_APTH + "apps/application/send/2/", bigData, AUTH)
            .then(res => {
                toast.success("OK");
                setMainModal(false);
...

                    {
                        toogle9
                            ...
                            <div className="many-checks">
                                <div className="row">
                                    <div className="my-input-groups col-md-12">
                                        <label className="open-sans-medium">{getText("ЕД2")}</label>
...

                        {
                            toogle9
                                ...
                                <div className="many-checks-items mt-4 ">
                                    <div className="row inputs-box pt-2 pb-2">
                                        <div className="my-input-groups col-md-12">
                                            <label className="open-sans-bold">{getText("ЕД2")}</label>
...
export default MedicalLaboratories;
